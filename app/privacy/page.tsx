...
const linkClassName = "link-hover text-[var(--accent)]";
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12 text-[var(--text)]">
      <header className="mb-10 border-b border-[var(--divider)] pb-6">
        <Link
          href="/"
          className="text-xl font-semibold tracking-[-0.3px] text-[var(--text)]"
        >
          🔖 {SERVICE_NAME}
        </Link>
      ...
      >
        ...
        <ol className="list-decimal space-y-1 pl-5 text-sm text-[var(--text-sub)]">
          <li>
            <a href="#s1" className="link-hover">
              개인정보의 처리 목적
            </a>
          </li>
          <li>
            <a href="#s2" className="link-hover">
              처리하는 개인정보의 항목
            </a>
          </li>
          <li>
            <a href="#s3" className="link-hover">
              개인정보의 처리 및 보유 기간
            </a>
          </li>
          <li>
            <a href="#s4" className="link-hover">
              개인정보의 파기 절차 및 방법
            </a>
          </li>
          <li>
            <a href="#s5" className="link-hover">
              개인정보 처리업무의 위탁
            </a>
          </li>
          <li>
            <a href="#s6" className="link-hover">
              정보주체의 권리·의무 및 행사방법
            </a>
          </li>
          <li>
            <a href="#s7" className="link-hover">
              개인정보의 안전성 확보 조치
            </a>
          </li>
          <li>
            <a href="#s8" className="link-hover">
              쿠키 운영 및 거부 방법
            </a>
          </li>
          <li>
            <a href="#s9" className="link-hover">
              개인정보 보호책임자
            </a>
          </li>
          <li>
            <a href="#s10" className="link-hover">
              권익침해 구제방법
            </a>
          </li>
          <li>
            <a href="#s11" className="link-hover">
              처리방침의 변경
            </a>
          </li>
        </ol>
